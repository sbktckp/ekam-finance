                ...
                {filtered.map(txn => {
                  ...
                  return (
                    <tr key={txn.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/60 transition-colors group">
                      ...
                      <td className="px-3 sm:px-6 py-4">
                        <div className="flex items-start gap-2.5">
                          ...
                          <div className="min-w-0">
                            <p className="text-sm font-semibold truncate max-w-[140px] sm:max-w-[200px]" style={{ color: 'rgba(255,255,255,0.92)' }}>
                              {txn.merchant ?? txn.note ?? 'Transaction'}
                            </p>
                            {txn.merchant && txn.note && (
                              <p className="flex items-center gap-1 mt-1 truncate max-w-[160px] sm:max-w-[220px]" style={{ color: 'rgba(255,255,255,0.55)', fontSize: '12px', fontWeight: 500 }}>
                      ...
                      <td className="px-2 sm:px-6 py-4 text-right align-top">
